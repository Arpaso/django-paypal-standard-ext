...
from meegenius.billing.forms import PayPalPaymentsForm
from meegenius.billing.models import Custom
...
def paypal_shortcut(request, obj, return_url='payment_done', cancel_url='index', form_class=PayPalPaymentsForm):
    ...
    form = form_class(initial={
        ...
        "image_url": "%s%s" % (settings.MEDIA_URL, getattr(settings, 'PAYPAL_IMAGE_URL', 'images/logo_header_chrome.png'))
    })
